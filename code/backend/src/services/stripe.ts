...
const PRODUCT_TO_TIER: Record<string, typeof TIERS.WEAVER | typeof TIERS.FABRICK> = {}

export function initProductMap(map: StripeProductMap): void {
  PRODUCT_TO_TIER[map.soloProductId] = TIERS.WEAVER
  PRODUCT_TO_TIER[map.teamProductId] = TIERS.WEAVER
  PRODUCT_TO_TIER[map.fabrickProductId] = TIERS.FABRICK
}

export function tierForProduct(productId: string): typeof TIERS.WEAVER | typeof TIERS.FABRICK | null {
...
export interface GeneratedLicense {
  key: string
  tier: typeof TIERS.WEAVER | typeof TIERS.FABRICK
  customerId: string
