...
describe('License Key System', () => {
  ...
  describe('parseLicenseKey — expiry and grace period', () => {
    ...
    it('should downgrade to demo for key expired beyond 30 days', () => {
      const expiredDate = new Date()
    ...
    it('should downgrade fabrick to demo beyond grace period', () => {
      const expiredDate = new Date()
    ...
    it('should keep expiry info even when downgraded to demo', () => {
      const expiredDate = new Date()
