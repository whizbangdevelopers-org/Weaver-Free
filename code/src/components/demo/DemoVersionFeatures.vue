      ...
      <q-card v-if="atLeast('2.1') && appStore.isWeaver" flat bordered>
        ...
        <q-card-section>
          ...
          <div class="row items-center q-gutter-sm q-mb-md">
            ...
            <span class="text-caption text-grey">Last GC: 2026-03-28</span>
            <q-space />
          ...
          <div class="row items-center q-gutter-sm q-mb-md">
            <span class="text-caption text-grey">Lock date: 2026-03-25</span>
      ...
      <template v-if="atLeast('1.2')">
        <q-card v-if="appStore.isWeaver" flat bordered class="q-mt-lg">
          <q-card-section>
            ...
            <div class="text-caption text-grey q-mb-sm">Full lifecycle management — v1.1 was read-only visibility</div>
            <q-markup-table flat dense bordered>
              <thead>
    ...
    <template v-if="section === 'fabrick'">
      ...
      <q-card v-if="atLeast('2.3') && appStore.isFabrick" flat bordered class="q-mb-lg">
        <q-card-section>
          ...
          <div class="text-caption text-grey q-mt-sm q-ml-md">
          ...
          <q-card-section>
            ...
            <div v-for="q in storageQuotas" :key="q.group" class="q-mb-sm">
              <div class="row items-center justify-between q-mb-xs">
                ...
                <span class="text-caption text-grey">{{ q.usedGb }} / {{ q.limitGb }} GB</span>
              </div>
        ...
        <q-card flat bordered class="q-mb-lg">
          <q-card-section>
            ...
            <div v-for="pool in billingPools" :key="pool.name" class="q-mb-md">
              ...
              <div class="text-caption text-grey q-mt-xs">{{ pool.remaining.toFixed(1) }} days remaining · renews at {{ pool.renewThreshold }} days</div>
            </div>
          </q-card-section>
        </q-card>
    ...
    <template v-if="section === 'weaver-team'">
      ...
      <q-card v-if="atLeast('2.2') && appStore.isWeaver && !appStore.isFabrick" flat bordered class="q-mt-lg">
        <q-card-section>
          ...
          <div class="text-caption text-grey q-mt-xs">Traffic weight: 85% blue / 15% green — AI monitoring health</div>
        </q-card-section>
      </q-card>
