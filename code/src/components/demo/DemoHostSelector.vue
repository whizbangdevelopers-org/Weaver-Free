  ...
  <div class="demo-host-selector row items-center no-wrap q-mr-sm">
    ...
    <template v-if="!isFabric">
      ...
      <q-tooltip anchor="bottom middle" self="top middle" :offset="[0, 8]">
        ...
        <div class="text-caption text-grey-4">Multi-host fleet management arrives in Fabrick v3.0</div>
      </q-tooltip>
    </template>
    ...
    <template v-else>
      ...
      >
        <q-list dense style="min-width: 200px">
          <q-item-label header class="text-uppercase text-grey-5" style="font-size: 0.65rem; letter-spacing: 0.08em">
            FabricK Hosts
          </q-item-label>
