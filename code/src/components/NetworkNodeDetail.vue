    ...
    <q-card-section>
      ...
      <div class="row q-gutter-lg">
        ...
        <div v-if="node.guestOs" class="col-auto">
          <div class="text-caption text-grey">Guest OS</div>
