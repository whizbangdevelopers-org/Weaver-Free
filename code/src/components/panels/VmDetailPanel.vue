...
<template>
  <div class="vm-detail-panel column full-height">
    ...
    <div v-else-if="!vm" class="col flex flex-center column text-center q-pa-lg">
      ...
      <div class="text-body2 text-grey q-mt-sm">VM "{{ vmName }}" not found</div>
    </div>
    ...
    <div v-else class="col scroll q-pa-md">
      ...
      <div class="q-mb-sm">
        ...
        <div
          ...
          :class="vm.description ? 'text-grey-7' : 'text-grey-5'"
      ...
      <div class="row q-gutter-sm q-mb-md">
        ...
        <q-card flat bordered class="col-auto">
          <q-card-section class="q-pa-sm text-center" style="min-width: 50px">
            <div class="text-caption text-grey">vCPU</div>
        ...
        <q-tab-panels v-model="activeTab" animated>
          ...
          <q-tab-panel name="logs">
            ...
            <div class="log-block rounded-borders q-pa-sm">
              ...
              <div v-else-if="logsContent" class="text-grey-4 text-mono" style="white-space: pre-wrap; font-size: 12px;">{{ logsContent }}</div>
          ...
          <q-tab-panel name="ai">
            ...
            <div v-if="vmOperations.length === 0" class="text-center text-grey q-pa-md">
