...
<template>
  <q-page class="q-pa-md">
    ...
    >
      ...
      <div class="text-h6 q-mt-md text-grey">No Virtual Machines Found</div>
      <div class="text-body2 text-grey q-mt-sm" style="max-width: 400px; margin: 0 auto">
    ...
    >
      ...
      <div class="text-h6 q-mt-md text-grey">No VMs match filters</div>
