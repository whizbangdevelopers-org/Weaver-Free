        ...
        <q-card-section class="row items-center wrap q-pa-sm q-px-md q-gutter-md">
          ...
          <div class="row items-center no-wrap q-gutter-sm col-auto">
            <div class="column items-center">
              <div class="text-caption text-grey" style="font-size:10px;line-height:1.2">Host</div>
              <q-icon name="mdi-desktop-tower" size="28px" color="teal-7" />
            </div>
            <div>
              <div class="text-weight-bold text-body2">{{ drillHost.hostname }}</div>
              <div class="text-caption text-grey no-wrap">
        ...
        >
          <q-card-section>
            ...
            <div class="row q-col-gutter-sm q-mb-md">
              <div class="col-4">
                <div class="stat-box">
                  <div class="stat-value" :class="getRunningCount(host.id) > 0 ? 'text-positive' : 'text-grey-5'">
              ...
              <div class="col-4">
                <div class="stat-box">
                  <div class="stat-value" :class="getIdleCount(host.id) > 0 ? 'text-grey-6' : 'text-grey-5'">
              ...
              <div class="col-4">
                <div class="stat-box">
                  <div class="stat-value" :class="getFailedCount(host.id) > 0 ? 'text-negative' : 'text-grey-5'">
