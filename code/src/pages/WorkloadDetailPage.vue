...
<template>
  <q-page class="q-pa-md">
    ...
    <div v-if="loading" class="text-center q-pa-xl">
      ...
      <div class="text-h6 q-mt-md text-grey">Loading VM details...</div>
    </div>
          ...
          <div class="col">
            ...
            <div class="q-mt-xs">
              ...
              <div
                ...
                :class="vm.description ? 'text-grey-8' : 'text-grey-5'"
      ...
      <div class="row q-gutter-md q-mb-lg">
        ...
        <q-card class="col-12 col-sm-auto">
          <q-card-section class="row items-center q-pa-sm q-px-md">
            ...
            <div>
              <div class="text-caption text-grey">vCPUs</div>
        ...
        <q-card v-if="vm.diskSize" class="col-12 col-sm-auto">
          <q-card-section class="row items-center q-pa-sm q-px-md">
            ...
            <div>
              <div class="text-caption text-grey">Disk Size</div>
        ...
        <q-card class="col-12 col-sm-auto">
          <q-card-section class="row items-center q-pa-sm q-px-md">
            ...
            <div>
              <div class="text-caption text-grey">Hypervisor</div>
        ...
        <q-tab-panels v-model="activeTab" animated>
          ...
          <q-tab-panel name="logs">
            ...
            <div class="log-placeholder rounded-borders q-pa-md">
              ...
              <div v-else-if="logsContent" class="text-grey-4 text-mono" style="white-space: pre-wrap;">{{ logsContent }}</div>
          ...
          <q-tab-panel name="ai">
            ...
            <div v-if="vmOperations.length === 0" class="text-center text-grey q-pa-lg">
    ...
    <div v-else class="text-center q-pa-xl">
      ...
      <div class="text-h6 q-mt-md text-grey">VM not found</div>
