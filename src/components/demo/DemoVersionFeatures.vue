...
-->
<template>
  <!-- Hidden entirely in public demo — no roadmap leaks -->
...
function atLeast(v: string): boolean {
  // Public demo: only show features that are in the current released Free version
...
function showNag(v: string): boolean {
  // Public demo: never show version nags — no roadmap leaks
